...
# PNG image data, 167 x 55, 8-bit/color RGB, non-interlaced
...
tf.app.flags.DEFINE_integer('max_stepsize', 12, 'it should be in the direction of "image_width", 12 in this project')
